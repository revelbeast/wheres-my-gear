...
export default function DashboardScreen() {
  ...
  function handleOpenScanQuickAction() {
    Alert.alert(
      "Unlock Premium+",
      "QR and barcode scanning is a Premium+ feature. Upgrade to Premium+ to unlock smart gear scanning, faster item setup, and future Gear Intelligence features.",
      [
                      ...
                      <ThemedCard style={styles.tabletPanelSpacing}>
                        ...
                        <View style={styles.tabletQuickActionsGrid}>
                          ...
                          <View style={styles.tabletQuickActionsRow}>
                            ...
                            >
                              <Lock size={18} color={quickActionColors.scan} />
